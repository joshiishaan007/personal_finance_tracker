...
// "Food & Dining" is too broad for a spending plan: groceries are a Need but a
...
const migration = {
  version: 6,
  description: 'Add Groceries and Dining Out as granular default categories for spending-plan bucket assignment',
